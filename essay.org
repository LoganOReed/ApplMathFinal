...
Due to Rellich's compacness lemma, the spectrum of the Dirichlet Laplacian consists only of discrete eigenvalues
...
This was eventually proven in any euclidean space by Faber and also independentally by Krahn \cite{extremum}.
